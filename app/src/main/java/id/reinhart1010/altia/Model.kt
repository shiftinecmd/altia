...
import id.reinhart1010.altia.util.inet4AddressFromInt
import id.reinhart1010.altia.util.maskWith
...
data class PortDescription(
    ...
    companion object {
        val commonPorts = listOf(
            ...
            PortDescription(0, 445, Protocol.TCP, "SMB", "Microsoft SMB Domain Server", null),
